// Напишите функцию, которая будет принимать координаты числа в треугольника Паскаля и
// будет возвращать значение по координатам
...
// x - порядковый номер в строке, y - номер строки
